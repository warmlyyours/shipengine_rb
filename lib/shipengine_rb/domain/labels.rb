  ...
  module Domain
    class Labels
      ...
      def create_from_rate(rate_id, params = {}, config: {})
        @internal_client.post("/v1/labels/rates/#{rate_id}", params, config)
      end
      ...
      def create_from_shipment_details(params, config: {})
        @internal_client.post('/v1/labels', params, config)
      end
      ...
      def void(label_id, config: {})
        @internal_client.put("/v1/labels/#{label_id}/void", {}, config)
      end
      ...
      def list_each(params = {}, config: {}, &)
        paginate_each(:list, :labels, params, config:, &)
      end
      ...
      def get_by_id(label_id, config: {})
        @internal_client.get("/v1/labels/#{label_id}", {}, config)
      end
      ...
      def get_by_external_shipment_id(external_shipment_id, config: {})
        @internal_client.get("/v1/labels/external_shipment_id/#{external_shipment_id}", {}, config)
      end
      ...
      def create_return_label(label_id, params = {}, config: {})
        @internal_client.post("/v1/labels/#{label_id}/return", params, config)
      end
      ...
      def create_from_shipment_id(shipment_id, params = {}, config: {})
        @internal_client.post("/v1/labels/shipment/#{shipment_id}", params, config)
      end
    end
  end
end
